...
//
//  Created by Mark Kenneth Bayona on 8/12/26.
//
...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        sut.simulateAppearance()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator once view appeared")
    ...
    func test_errorView_doesNotRenderErrorOnLoadAndAppearance() {
        let (sut, _) = makeSUT()
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view1?.renderedImage, image1, "Expected image for second view once second image loading completes successfully")
    }
    ...
    func test_feedImageView_cancelsImageURLPreloadingWhenNotNearVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected second cancelled image URL requests once second image is not near visible anymore")
    }
